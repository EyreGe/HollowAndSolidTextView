...
public class SolidText extends View {
    /**
     * 文本内容
     */
    ...
    public SolidText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SolidText(Context context) {
        this(context, null);
    }
     ...
     * @param defStyle
     */
    public SolidText(Context context, AttributeSet attrs, int defStyle) {
